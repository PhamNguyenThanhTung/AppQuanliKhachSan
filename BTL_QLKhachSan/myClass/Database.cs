...
namespace BTL_QLKhachSan.myClass
{
    class Database
    {
        ...
        private string connectionString = "Data Source=DESKTOP-MUUEIFA\\SINES;Initial Catalog=QLKhachSan;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False";
